...
const Profile = () => {
  ...
  const itemsChange = [{
    title: <View style={{flex:1, flexDirection:'row',justifyContent:'center'}}>
  ...
  return (
    <View style={{ flex: 1 }}>
      <View
        style={{ height: undefined, backgroundColor: 'white', marginBottom: 3 }}
      >
        <ImageBackground source={background} style={{
          width: '100%', height: 200, flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-end'
        }}>
          <Avatar.Image size={80} source={avt}
            style={{ position: 'absolute', bottom: -30, left: '50%', transform: [{ translateX: -35 }] }} />
